...
class NeuralNet(BaseEstimator):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.custom_epoch_scores = custom_epoch_scores
    ...
    def train_loop(self, X, y, epochs=None):
        ...
        while epoch < epochs:
            ...
            for Xb, yb in iterator:
                ...
                if self.custom_scores or self.custom_epoch_scores:
            ...
            if self.custom_epoch_scores:
                ...
                self.y_pred_validation = y_pred_epoch
                self.y_true_validation = y_valid
